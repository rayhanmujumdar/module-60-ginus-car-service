    ...
    return (
        <div className='min-h-screen'>
            ...
            <form onSubmit={handlePlaceOrder} className='flex flex-col gap-y-3 justify-center items-center bg-red-300 md:w-2/4 w-5/6 mx-auto py-20 rounded-md px-6'>
                <input value={user.displayName} className='border border-black px-2 h-10 w-full' type="text" name='name' placeholder='Your Name' required disabled/>
                ...
                <input defaultValue={service?.name} className='border border-black px-2 h-10 w-full' type="text" name='service' placeholder='Service' required readOnly/>
